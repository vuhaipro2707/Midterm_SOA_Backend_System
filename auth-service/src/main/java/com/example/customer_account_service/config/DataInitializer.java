...
public class DataInitializer {
        ...
        return args -> {
            ...
            if (customerRepository.count() == 0) {
                ...
                List<Customer> initialCustomers = Arrays.asList(
                    ...
                    createCustomer("user1", "123", "Nguyễn Văn A", "0901234567", 5000000, "ROLE_USER"),
                    
                    // Khách hàng 2: user có vai trò quản trị (để test phân quyền sau này)
                    createCustomer("user2", "1234", "Trần Thị B", "0918765432", 10000000, "ROLE_ADMIN"),

                    // Khách hàng 3: user khác
                    createCustomer("user3", "12345", "Phạm Văn C", "0987654321", 1000000, "ROLE_USER")
                );
    ...
    private Customer createCustomer(String username, String rawPassword, String fullName, String phoneNumber, Integer balance, String roles) {
